...
export const Domains: { [key: string]: IDomain } = {
  'default': { url: environment.DOMAIN_URL.split('://')[1], fullUrl: environment.DOMAIN_URL, apiUrl: environment.API_BASE_URL, name: 'MAK', logoLightBg: 'assets/images/mak-logo-light-bg.svg', logoDarkBg: 'assets/images/mak-logo-dark-bg.svg', favicon: 'assets/mak-favicon.ico' },
